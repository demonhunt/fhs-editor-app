...
class ScanSKU extends Component {
  ...
  ShowConfirmBlock(isShowConfirmBlock) {
    <AlertComfirmBlock isShowConfirmBlock={isShowConfirmBlock}
                            messageBlock={"Thong bao"} leftTitle={"Co"} rightTitle={"Khong"}>
          </AlertComfirmBlock>
  }
      ...
      .catch(e =>{
        if(e == "scanfail")
        {
          ...
          this.setState({
            ...
            this.ShowConfirmBlock(this.state.isShowConfirmBlock)
