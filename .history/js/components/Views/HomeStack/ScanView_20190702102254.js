    ...
    let data = {
      ...
      .catch(e =>{
        if(e == "scanfail")
        {
          ...
          <AlertConfirmBlock leftTitle={"Có"} rightTitle={"Không"} messageBlock={"Thông báo"} isShowConfirmView={this.state.isShowConfirmView} callBack={() => { this.setState({modalVisible: false}) }}></AlertConfirmBlock>
          this.turnOnCamera();
        }
        else {
        }
