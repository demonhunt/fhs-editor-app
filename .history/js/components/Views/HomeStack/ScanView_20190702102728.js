    ...
    let data = {
      ...
      .catch(e =>{
        if(e == "scanfail")
        {
          ...
          <AlertConfirmBlock leftTitle={"Có"} rightTitle={"Không"} messageBlock={"Thông báo"} isShowConfirmBlock={true} callBack={() => { this.setState({isShowConfirmBlock: false}) }}></AlertConfirmBlock>
          this.turnOnCamera();
        }
        else {
        }
