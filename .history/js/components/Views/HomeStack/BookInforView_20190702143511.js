  ...
  render() {
    ...
    return (
      ...
      <Header headerCenter={"Thông tin sách"}></Header>
        ...
        <Footer navigation = {this.props.navigation} showRightButton={'orange'} rightText={'Thêm'} callBackRight={() => { this.savehistory(this.state.data.sku,this.state.data.name,true)}}></Footer>
      </View>
    );
  }
}
